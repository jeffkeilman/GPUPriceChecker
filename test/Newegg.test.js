...
const fp1 = path.join(__dirname, 'test_artifacts/Newegg/Newegg_items1.html')
const fp2 = path.join(__dirname, 'test_artifacts/Newegg/Newegg_items2.html')
const fp3 = path.join(__dirname, 'test_artifacts/Newegg/Newegg_items3.html')
const fp4 = path.join(__dirname, 'test_artifacts/Newegg/Newegg_items4.html')
